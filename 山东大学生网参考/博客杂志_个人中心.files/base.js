...
document.write("<script type='text/javascript' src='http://my.blog.sina.com.cn/js/" + BROWSER + ".js?0801.js'></script>");
var CACHE = {"outline":[]};
var CONFIG = {"readfile":""};
var AONLOAD = [];
...
function ResizeSWF(nWidth, nHeight) {
	var swf = $("music");
	var obj = $("musicFlash");
	swf.style.width = nWidth+"px";
	swf.style.height = nHeight+"px";
	obj.width = nWidth+"px";
	obj.height = nHeight+"px";
}
