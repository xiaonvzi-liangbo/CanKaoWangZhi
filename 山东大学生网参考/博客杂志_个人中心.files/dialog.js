function dialog(){
	...
	var sBox = '\
		<table id="dialogBox" width="' + width + '" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #000;display:none;z-index:10;" alt="dialog">\
			...
			<tr>\
				<td height=30><iframe id="adframe" style="background:#FFFFFF;height:30px; width: 100%;" scrolling=no frameborder=0 src="http://blog.sina.com.cn/lm/iframe/20/20070406/16.html"></iframe></td>\
			</tr>\
		</table>\
	...
	this.show = function(){
		...
		this.shadow();
		$('adframe').src = 'http://blog.sina.com.cn/lm/iframe/20/20070406/16.html';
