var countid=203045651;var logo=1;
...
document.write('<img width=20 height=20 border=0 hspace=0 vspace=0 src="http://count20.51yes.com/count'+ logo +'.gif" alt="51YES网站统计系统"></a>');}
else
{document.write('<a href="http://count.51yes.com/index.aspx?id='+ countid +'" target=_blank title="51YES网站统计系统">流量统计</a>');}
document.write('<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src=http://count20.51yes.com/sa.aspx?id='+countid+yesdata+' height=0 width=0></iframe>');
