...
_st_title=document.title + "   ";
_st_charset=document.charset;

_st_url=document.URL; 
_st_url=_st_u_en(String(_st_url)); 
_st_title=escape(_st_title); 
_st_charset=_st_u_en(String(_st_charset)); 
_st_clr=_st_g_sc(); 
